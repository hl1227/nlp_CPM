...
def set_args():
    ...
    parser.add_argument('--vocab_path', default='vocab/chinese_vocab.model', type=str, required=False,
                        help='sp模型路径')
    parser.add_argument('--model_config', default='config/cpm-medium.json', type=str, required=False,
    ...
    parser.add_argument('--max_len', default=500, type=int, required=False, help='训练时，输入数据的最大长度')
    ...
    parser.add_argument('--save_model_path', default='model', type=str, required=False,
                        help='模型输出路径')
    parser.add_argument('--pretrained_model', default='model/pretrained_model', type=str, required=False,
                        help='预训练的模型的路径')
